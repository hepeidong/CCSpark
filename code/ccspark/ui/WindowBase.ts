...
import { cc_spark_win_model, IAssetRegister, IRegister, IWindowBase } from "../lib.ccspark";
...
export class WindowBase<T extends Component> extends Mediator implements IWindowBase {
    ...
    private _winModel: cc_spark_win_model;      //窗口模型
    ...
    public get winModel(): cc_spark_win_model { return this._winModel; }
    ...
    /** 设置UI类型*/
     public iniViewType(): void {
        ...
        if (Assert.handle(Assert.Type.InitViewTypeException, this._viewType, message)) {
            this._winModel = UIType[this._viewType] as cc_spark_win_model;
        }
    }
