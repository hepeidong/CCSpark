...
import { cc_spark_bitLblImage_type } from "../lib.ccspark";
...
export  class BitmapLabel extends Component {
    ...
    private cutImage(str: string) {
        ...
        let imageList: cc_spark_bitLblImage_type[] = [];
    ...
    private showLabel() {
        let imageList: cc_spark_bitLblImage_type[] = this.cutImage(this.string);
        this.removeChild();
