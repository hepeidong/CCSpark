...
import { cc_spark_animat_frameAnimat_type, cc_spark_animat_resolved_type, IFrameAnimat } from "../lib.ccspark";
import { utils } from "../utils";

export  class FrameAnimat extends AnimatBase<cc_spark_animat_frameAnimat_type> {
