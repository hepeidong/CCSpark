...
import { cc_spark_animat_dragonBonesAnimat_type, cc_spark_animat_resolved_type, cc_spark_animat_spineAnimat_type, IDragonBonesAnimat } from "../lib.ccspark";
...
export  class DragonBonesAnimat extends AnimatBase<cc_spark_animat_dragonBonesAnimat_type> {
    ...
    public addCallback(callback: cc_spark_animat_resolved_type): void {
