import { cc_spark_socket_protocol, IResponseSocketData, ISocket } from "../lib.ccspark";
 ...
 */
export abstract class GameSocket<T> implements ISocket {
    protected _protocolType: cc_spark_socket_protocol;
    ...
    public abstract link(url: string): Promise<void>;
